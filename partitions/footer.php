    ...
    <footer>
        <section class="footer__section">
            ...
            <ul style="padding: 0; margin: 0; list-style: none;">
                <li class="footer__li"><a class="footer__a" href="mailto:edgar.avila.rro@gmail.com">Correo</a></li>
                <li class="footer__li"><a class="footer__a" href="tel:+524271861970">Teléfono</a></li>
